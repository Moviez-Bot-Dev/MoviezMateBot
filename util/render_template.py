#Thanks @Mania24SupportBot helping this journey 
...
async def render_page(id, secure_hash, src=None):
    file = await Moviezमंत्रBot.get_messages(int(LOG_CHANNEL), int(id))
    file_data = await get_file_ids(MoviezMateBot, int(LOG_CHANNEL), int(id))
