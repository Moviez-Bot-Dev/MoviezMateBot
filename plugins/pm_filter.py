...
async def give_filter(client, message):
    ...
    reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📷 ᴊᴏɪɴ ᴏᴜʀ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ 🎥 ", url=f"https://t.me/Find_Movie_Series_Request_Group")]])
)
...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         text=f"<b>ʜᴇʏ {user} 😍 , ʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ᴍᴏᴠɪᴇs ꜰʀᴏᴍ ʜᴇʀᴇ. ʀᴇǫᴜᴇsᴛ ɪᴛ ɪɴ ᴏᴜʀ <a href=https://t.me/Find_Movie_Series_Request_Group>👉🏻 ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ 👈🏻</a> ᴏʀ ᴄʟɪᴄᴋ ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ👇🏻.</b>",   
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ", url=f"https://t.me/Find_Movie_Series_Request_Group")]])
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("Rᴇᴏ̨ᴜᴇsᴛ Gʀᴏᴜᴘ Lɪɴᴋ", url="https://Find_Movie_Series_Request_Group")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("Rᴇᴏ̨ᴜᴇsᴛ Gʀᴏᴜᴘ Lɪɴᴋ", url="https://telegram.me/Find_Movie_Series_Request_Group")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
    ...
    elif maniaData.startswith("generate_stream_link"):
        _, file_id = maniaData.split(":")
        try:
            user_id = query.from_user.id
            ...
            await log_msg.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🛡 Fast Download", url=mania_download),  # we download Link
                                                    InlineKeyboardButton('▶ Watch online', url=mania_stream)]])  # web stream Link
            )
            ...
            return
    # don't change anything without contacting me @Mania24SupportBot
        ...
        buttons = [[
            InlineKeyboardButton('♛┈⛧┈┈•ᴘᴀɪᴅ•┈┈⛧┈♛', callback_data='about')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await client.edit_message_media(
            query.message.chat.id, 
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="help"),
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="telegram.me/Mania24SupportBot")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
