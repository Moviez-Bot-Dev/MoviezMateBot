...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('✪ Sᴜᴘᴘᴏʀᴛ Cʜᴀᴛ', url="https://t.me/Netflix_Bollywood_Movie_Series"),
                    InlineKeyboardButton('⌬ Mᴏᴠɪᴇ Gʀᴏᴜᴘ', url="https://t.me/Find_Movie_Series_Request_Group")
                ],[
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                ...
                                InlineKeyboardButton('ʙᴏᴛ ᴏᴡɴᴇʀ ᴄᴏɴᴛᴀᴄᴛ', url="https://t.me/Mania24SupportBot")
                            ],
                            [
                                InlineKeyboardButton('🚀 Fast Download / Watch Online🖥️', callback_data=f'generate_stream_link:{file_id}') #Don't change anything without contacting me @Mania24SupportBot
                            ]
                        ]
                    )
                )
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                         [
                          ...
                          InlineKeyboardButton("ʙᴏᴛ ᴏᴡɴᴇʀ ᴄᴏɴᴛᴀᴄᴛ", url="t.me/Mania24SupportBot")
                         ],[ 
                            InlineKeyboardButton('🚀 Fast Download / Watch Online🖥️', callback_data=f'generate_stream_link:{file_id}') #Don't change anything without contacting me @Mania24SupportBot
                            ]
                        ]
    ...
    if not files_:
        ...
        try:
            ...
            title = '@Netflix_Bollywood_Movie_Series  ' + ' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), file.file_name.split()))
    ...
    files = files_[0]
    title = '@Netflix_Bollywood_Movie_Series  ' + ' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), files.file_name.split()))
    ...
    if CUSTOM_FILE_CAPTION:
        try:
            ...
            f_caption=f_caption
    if f_caption is None:
        f_caption = f"@Netflix_Bollywood_Movie_Series  {' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), files.file_name.split()))}"
    if not await check_verification(client, message.from_user.id) and VERIFY == True:
        btn = [[
            InlineKeyboardButton("Verify", url=await get_token(client, message.from_user.id, f"https://telegram.me/{temp.U_NAME}?start="))
        ]]
...
async def shortlink(bot, message):
    ...
    chat_type = message.chat.type
    if chat_type == enums.ChatType.PRIVATE:
        return await message.reply_text(f"<b>Hey {message.from_user.mention}, This command only works on groups !\n\n<u>Follow These Steps to Connect Shortener:</u>\n\n1. Add Me in Your Group with Full Admin Rights\n\n2. After Adding in Grp, Set your Shortener\n\nSend this command in your group\n\n—> /shortlink ""{your_shortener_website_name} {your_shortener_api}\n\n#Sample:-\n/shortlink gplinks.in 67526341652d5e4c793538eaf39bdd1f37ab9c1d\n\nThat's it!!! Enjoy Earning Money 💲\n\n[[[ Trusted Earning Site - https://gplinks.in]]]\n\nIf you have any Doubts, Feel Free to Ask me - @Mania24SupportBot\n\n(Reply as soon as possible - @Mania24SupportBot)</b>")
    elif chat_type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
    ...
    try:
        ...
        return await message.reply_text("<b>Command Incomplete :(\n\nGive me a shortener website link and api along with the command !\n\nFormat: <code>/shortlink gplinks.in 67526341652d5e4c793538eaf39bdd1f37ab9c1d</code></b>")
