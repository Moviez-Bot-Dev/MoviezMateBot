...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Mania_Request')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Updated_Mania')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Updated_Mania/39')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Hello Dear ❤️')
